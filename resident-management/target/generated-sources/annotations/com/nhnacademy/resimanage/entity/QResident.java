...
public class QResident extends EntityPathBase<Resident> {
    ...
    private static final long serialVersionUID = 2029816356L;

    public static final QResident resident = new QResident("resident");

    public final ListPath<FamilyRelationship, QFamilyRelationship> baseFamilyRelationshipList = this.<FamilyRelationship, QFamilyRelationship>createList("baseFamilyRelationshipList", FamilyRelationship.class, QFamilyRelationship.class, PathInits.DIRECT2);
